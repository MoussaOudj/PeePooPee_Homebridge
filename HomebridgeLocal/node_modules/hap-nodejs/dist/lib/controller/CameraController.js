    ...
    CameraController.prototype.handleSnapshotRequest = function (height, width, accessoryName, reason) {
        ...
        return new Promise(function (resolve, reject) {
            var timeout = setTimeout(function () {
                console.warn("[".concat(accessoryName, "] The image snapshot handler for the given accessory is slow to respond! See https://git.io/JtMGR for more info."));
                timeout = setTimeout(function () {
                    timeout = undefined;
                    console.warn("[".concat(accessoryName, "] The image snapshot handler for the given accessory didn't respond at all! See https://git.io/JtMGR for more info."));
