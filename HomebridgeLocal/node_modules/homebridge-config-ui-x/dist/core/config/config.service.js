...
let ConfigService = class ConfigService {
    constructor() {
        ...
        this.minimumNodeVersion = '10.17.0';
        ...
        this.runningInLinux = (!this.runningInDocker && !this.runningInSynologyPackage && os.platform() === 'linux');
        ...
        this.enableTerminalAccess = this.runningInDocker || this.runningInSynologyPackage || Boolean(process.env.HOMEBRIDGE_CONFIG_UI_TERMINAL === '1');
